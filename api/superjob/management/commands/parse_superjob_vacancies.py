...
from modules.vacancies_parser.api.superjob.scripts import parse_vacancies_by_text, parse_all_vacancies
from modules.vacancies_parser.api.superjob.tasks import parse_superjob_vacancies_task
    ...
    def handle(self, *args, **options):
        ...
        if options.get('universal'):
            ...
            if options.get('wait'):
                ...
                # Асинхронный режим
                from modules.vacancies_parser.api.superjob.tasks import parse_all_superjob_vacancies_task
