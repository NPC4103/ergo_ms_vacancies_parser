...
from modules.vacancies_parser.api.superjob.scripts import get_vacancy_details
from modules.vacancies_parser.api.superjob.tasks import get_superjob_vacancy_details_task
    ...
    def handle(self, *args, **options):
        ...
        if options.get('wait'):
            ...
            if options.get('save') and vacancy_data:
                from modules.vacancies_parser.api.superjob.scripts import parse_vacancy_data, save_vacancy_to_db
